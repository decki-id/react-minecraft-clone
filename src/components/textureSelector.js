...
export const textureSelector = () => {
    const
        ...
        [activeTexture, setTexture] = useStore((state) => [state.texture, state.setTexture]),
        { dirt, grass, glass, wood, log } = useKeyboard()
    ...
    useEffect(() => {
        const
            ...
            pressedTexture = Object.entries(textures).find(([k, v]) => v)
